...

{
    ...
    if(q==3)
    {
        ...
        printf("Player 1 has got 1.5 and Player 2 has got 1.5\n");
        
        fscanf(fp1,"%f",&playerone);
    	playerone += 1.5;
    	fclose(fp1);
    	
    	fscanf(fp2,"%f",&playertwo);
    	playertwo += 1.5;
    	fclose(fp2);
    	
    	printf("total point of Player 1 is = %.2f & Player 2 is = %.2f",playerone,playertwo);
    	
    	fp1 = fopen("playerone.txt","w");
    	fprintf(fp1,"%.2f",playerone);
    	fclose(fp1);
    	
    	fp2 = fopen("playertwo.txt","w");
    	fprintf(fp2,"%.2f",playertwo);
    	fclose(fp2);
    }
    else
    {
    	...
    	if(winner == 1)
    	{
    		...
    		fscanf(fp1,"%f",&playerone);
    		fclose(fp1);
    		printf("Player %d total point is = %.2f",winner,playerone);
		...
		else
		{
    		...
    		fscanf(fp2,"%f",&playertwo);
    		fclose(fp2);
    		printf("Player %d total point is = %.2f",winner,playertwo);
		}
    }
